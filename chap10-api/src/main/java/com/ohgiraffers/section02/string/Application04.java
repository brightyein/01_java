...
public class Application04 {
    public static void main(String[] args) {
        ...
        /*
        * 이스케이프(escape) 문자
        * 문자열 내 사용하는 문자 중 특수문자를 표현하거나 특수기능을 사용할 때 사용하는 문자.
        *       \n : 개행(줄바꿈)
        *       \t : 탭
        *       \' : 작은 따옴표
        *       \" : 큰 따옴표
        ...
        * */
        ...
        System.out.println("안녕하세요. 저는 '홍길동' 입니다."); // 문자열안에서 ' 사용은 무방
        // System.out.println('''); 문자로서 ' 만을 사용하고 싶다면
        System.out.println('\'');

        // System.out.println("안녕하세요, 저는 "홍길동" 입니다."); // 문자열안에서 " 사용하면 에러
        System.out.println("안녕하세요, 저는 \"홍길동\" 입니다.");

        // System.out.println("안녕하세요, 저는 \홍길동\ 입니다."); // 그냥 \ 를 쓰면 에러
        System.out.println("안녕하세요, 저는 \\홍길동\\ 입니다.");

        /*
        * split() 시 이스케이프 문자를 사용해야하는 특수문자도 존대한다.
        *
        * 사용 안하는 특수문자
        * ~ ' ! @ # $ % & - _ = ; : ' \ " , < > /
        *
