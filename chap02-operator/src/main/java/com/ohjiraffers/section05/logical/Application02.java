...
public class Application02 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("1부터 100사이에 있는지 확인: " + (num1 >= 1 && num1 <= 100)); // true

        System.out.println("----------------------------------------");

        // 영어 대문자 확인
        char ch1 = 'G';
        System.out.println("영어 대문자 확인 : " + (ch1 >= 'A' && ch1 <= 'Z')); // true

        char ch2 = 'g';
        System.out.println("영어 대문자 확인 : " + (ch2 >= 'A' && ch2 <= 'Z')); // false
        ...
        char ch5 = 'f'; // 아스키코드 숫자 확인하여 범위 설정
