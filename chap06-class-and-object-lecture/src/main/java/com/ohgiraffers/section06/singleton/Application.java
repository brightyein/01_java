...
public class Application {
    public static void main(String[] args) {
         ...
         *
         * 장점
         * 1. 첫 번째 이용 시, 인스턴스를 생성해야해서 속도 차이가 나지 않지만
         *    두 번째 이용 시, 인스턴스 생성 시간 없이 사용 가능
        ...
        // 이른초기화 구현
        // EagerSingleTon eager1 = new EagerSingleTon(); // private 이라서 생성자로 객체를 생성할 수 없음
        ...
        // 게으른 초기화 구현
        // LazySingleton lazy1 = new LazySingleton(); // private 이라서 생성자로 객체를 생성할 수 없음
