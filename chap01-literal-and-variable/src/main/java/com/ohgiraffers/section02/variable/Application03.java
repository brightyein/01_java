...
public class Application03 {
    public static void main(String[] args) {
        ...
        *   1-2. 예약어는 사용이 불가하다 (예약어 : 프로그램에서 미리 사용하겠다고 컴파일러와 약속한 키워드)
        *   1-3. 변수명은 대/소문자를 구분한다. (자바는 대/소문자를 엄격하게 구분하는 언어)
        *   1-4. 변수명은 숫자로 시작할 수 없다 (시작하는 것만 불가하고 숫자를 섞어 사용하는 것은 가능)
        ...
        *   2-5. 변수 안에 저장된 값이 어떤 의미를 갖는지 명확히 표현
        ...
        * */
        ...
        // 1-2. 동일한 범위 내 (동일 메서드 안) 동알한 변수명을 가질 수 없다.
        int age = 20;
        // int age = 10; > age 중복
        ...
        // 2-1. 에러를 발생시키진 않지만 개발자들끼리의 암묵적 규칙
        int skfoewkmksjdlgklsdjkfdsfdlekwlkrnjs;

        // 2-2. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두 번째 단어의 시작은 대문자로 한다.
        // 자바에서는 클래스명만 유일하게 대문자로 시작한다.
        int MaxAge = 20; // 이렇게 표현해도 문법적으론 무방하나 사용하지 않음.
        int maxAge = 20; // 올바른 표현

        // 2-3. 단어와 단어 사이의 연결은 언더스코어(_) 를 사용하지 않는다.
        String user_name; // 스네이크 케이스
        String userName; // 올바른 표현 > 카멜케이스

        // 2-4. 한글로 변수명을 짓는 것은 가능하지만 권장되지 않는다.
        int 나이;

        // 2-5. 변수 안에 저장된 값이 어떤 의미를 가지는지 명확히 표현한다.
        String s;
        String name;
        ...
        // 2-8. boolean 형은 의문문, 가급적 부정보단 긍정 형태로
