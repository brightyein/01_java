...
public class Application02 {
    public static void main(String[] args) {
        ...
        * */
        ...
        // int bonus;
        // System.out.println(bonus); > 어떤 값을 넣기전엔 변수를 사용할 수 없음

        /*
        * 변수에는 자료형이 존재한다. (메모리를 효율적으로 사용하기 위해)
        ...
        * 1bit 는 0과 1 둘 중 하나의 값만 가질 수 있는 데이터의 최소 단위이다.
        ...
        */
        ...
        /* 논리값을 취급하는 자료형 */
        /* 1byte 논리 데이터 형은 0과 1의 값으로 데이터를 취급하기 때문에 1bit로 표현 가능하지만, 최소단위가 1byte이기 때문에 1byte 크기를 갖는다.
         */
        ...
        * 일반적으로 사용하는 값을 독특한 형태가 아닌 일반적인 형태로 사용할 수 있는 잘형을 대표자료형 이라고 한다.
        ...
        * */
        ...
        bonus = bonus + 100; // bonus += 100; 이랑 같은 의미
